                  ...
                  <ListItem>
                    ...
                    >
                      <Typography>
                        ...
                        exploits the use of repetition and understated
                        development. Minimal techno is thought to have been
                        originally developed in the early 1990s by Detroit-based
                  ...
                  <ListItem>
                    <ListItemText sx={{ marginY: 0 }}>
                      <Typography>
                        ...
                        Singapore to use design for economic growth and to make
                        lives better.
                      </Typography>
                    </ListItemText>
                  </ListItem>
            ...
            <Grid xs={6}>
              <Grid>
                <Booking>
                  ...
                  <Typography variant="caption">Discount 20% Off </Typography>
                  <BookingCalender />
                </Booking>
              </Grid>
            </Grid>
