...
const tableBody: GridColDef[] = [
  ...
  },
  {
    ...
    editable: false,
    renderCell: (params) => {
      return <span>{ moment(params?.row?.startDate).format("Do MMM YY")}</span>
    },
  },
  {
    field: 'endDate',
  ...
  },
  {
    ...
    editable: false,
    renderCell: (params) => {
      return params.formattedValue==="pending"?<Chip label={"pending"} size="small" color="warning" />:params.formattedValue
